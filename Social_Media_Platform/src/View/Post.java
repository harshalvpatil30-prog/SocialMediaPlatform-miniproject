...
public class Post extends JPanel {
    ...
    public Post(User u, Model.Post post, Database database, JFrame f) {
        ...
        javax.swing.JLabel like = new javax.swing.JLabel(new ImageIcon(getClass().getResource("/SocialMediaPlatform/pics/like.png")));
        like.setCursor(new Cursor(Cursor.HAND_CURSOR));
        if (u.liked(post)) {
            like.setIcon(new ImageIcon(getClass().getResource("/SocialMediaPlatform/pics/liked.png")));
        } else {
            like.setIcon(new ImageIcon(getClass().getResource("/SocialMediaPlatform/pics/like.png")));
        }
